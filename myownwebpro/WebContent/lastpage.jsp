	...
	<div >
			<table class="nav nav-pills nav-justified table-condensed table-striped">
				...
				for(int i= 0; i<po.size(); i++) { 
					PurchaseOrder purchaseOrder = (PurchaseOrder)po.get(i);
				%>PurchaseOrder
				<tr>
					...
					<td></td>
					<td><%= purchaseOrder.getOriginAddress().getItems() %></td>
					<td><%= purchaseOrder.getOriginAddress().getShipFrom() %></td>
					<td><%= purchaseOrder.getDesignationAddress().getShipTo() %></td>

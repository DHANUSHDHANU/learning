			...
			<div class="row comtainer text-center">
				<div class="col-md-4 ">
					<div class="row" style="text-align: left;">
						...
						<div class="col-md-offset-1 col-md-4 ">
							<input type="text" name="poisuuedate" id="poisuuedate">
						</div>
						<div class=" col-md-offset-1 col-md-4 ">
						...
						<div class="col-md-offset-1 col-md-4 ">
							<input type="text" name="designationmode" id="designationmode">
						</div>
					</div>
				</div>
				<div class="col-md-4 ">
					<div class="row" style="text-align: left;">
						...
						<div class="col-md-offset-1 col-md-4 ">
							<input type="text" name="shipto" id="shipto1">
						</div>
						<div class=" col-md-offset-1 col-md-4 ">
				...
				<div class="col-md-4 ">
					<div class="row" style="text-align: left;">
						...
						<div class="col-md-offset-1 col-md-4 ">
							<input type="checkbox" name="shifttogether" id="shifttogether">
						</div>
					</div>
				</div>
			</div>
